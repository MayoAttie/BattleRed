...
public class GameManager : Singleton<GameManager>
{
    ...
    private void Awake()
    {
        ...
        List<ItemClass> weaponList = new List<ItemClass>
        {
            ...
            new WeaponAndEquipCls("무기", "제례검", 4, false, 1, 65000, 1,20, "기나긴 세월을 거쳐 석화한 검은 의례적인 장식이 여전히 선명하게 보인다.\n시간의 바람에 씻긴 축복의 힘을 보유하고 있다", "","원소 전투 스킬로 피해를 줄 때 <color=#00FFFF>40%</color>의 확률로 해당 스킬의 재발동 대기시간이 초기화된다. 해당 효과는 <color=#00FFFF>30초</color>마다 1번 발동한다",1,470,13.3f,100,800),
